  ...
  return (
    <>
      <svg style={svgStyle} height={500} width={500} viewBox="-150 -150 500 500">
        ...
        <g>
          {/* (1,0) */}
          <polygon points="87,50 174,100 174,200 87,250 0,200 0,100 " fill='none' stroke='black'></polygon>
        </g>
        <g>
          {/* (1,0) */}
          <polygon points="174,-100 261,-50 261,50 174,100 87,50 87,-50 " fill='none' stroke='black'></polygon>
        </g>
